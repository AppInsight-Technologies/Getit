...
class IConstants {
  static String BaseDomain =
      // "https://login.purityprayag.com";
  "https://sandbox.grocbay.com";
      //"https://saas.grocbay.com";
  ...
  static String androidId = "" /* = com.getit.store"*/;
  ...
  static String refIdForMultiVendor = "1138"/*"5000"*/;
