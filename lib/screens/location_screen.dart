      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(
              child: Text(
                S.of(context).lets_check,//'Let\'s first check that we deliver to your address',
          ...
          Text(
            S.of(context).ready_to_order,//'Ready to order from our shop?',
            style: TextStyle(
                fontSize: 10.0,
                color: Colors.grey
            ),
          ...
          GestureDetector(
            ...
            child: Container(
                ...
                child: Center(
                  child: Text(
                    S.of(context).set_delivery_location,//'SET DELIVERY LOCATION',
                    textAlign: TextAlign.center,
