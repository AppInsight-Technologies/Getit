...
import '../../widgets/membership_web.dart';
...
class _HeaderState extends State<Header> with Navigations {
  ...
  void _getUserLocation() async {
    var position = await GeolocatorPlatform.instance
        .getCurrentPosition();
    debugPrint("first....1..");
    _getaddres(LatLng(position.latitude, position.longitude));
  }
 _getaddres(LatLng latLng) async{
      ...
      for (int i = 1; i < dataAddress.length; i++) {
        ...
        debugPrint("_address,,.."+_address.toString());
      }
  }
