...
class SellingItemsv2 extends StatefulWidget {
  ...
  final String _seeallpress;
  final ItemData _itemdata;

  Map<String, String> returnparm;

  SellingItemsv2(this._fromScreen,this._seeallpress,
     this._itemdata,{this. returnparm});

  @override
  _SellingItemsv2State createState() => _SellingItemsv2State();
}

class _SellingItemsv2State extends State<SellingItemsv2> {
 // Box<Product> productBox;
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      setState(() {
        if ((VxState.store as GroceStore).userData.membership=="1") {
          ...
          debugPrint("membership....."+_checkmembership.toString());
        } else {
          setState(() {
            _checkmembership = false;
            debugPrint("membership.....1"+_checkmembership.toString());
          });
          for (int i = 0; i < productBox.length; i++) {
            if (productBox[i].mode == "1") {
              setState(() {
                _checkmembership = true;
                debugPrint("membership.....3"+_checkmembership.toString());
              });
            }
          }
        }
    ...
    setState(() {
      ...
      if(widget._itemdata.wishlist ==1) {
        widget._itemdata.isSelect = true;
      } else {
        widget._itemdata.isSelect = false;
      }
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
   ...
   /* if (widget._fromScreen == "home_screen") {
    ...
    _notifyMe() async {
      ...
      //_notifyMe();
      int resposne = await Provider.of<BrandItemsList>(context, listen: false).notifyMe(widget._itemdata.id,varid,widget._itemdata.type);
      if(resposne == 200) {
...
*//*
    ...
    addToCart(PriceVariation priceVariation, ItemData itemdata,) async {
      cartcontroller.addtoCart(priceVariation,itemdata,(isloading){
        setState(() {
    ...
    updateCart(int qty,CartStatus cart,String varid){
      switch(cart){
        ...
        case CartStatus.increment:
          ...
          },price: widget._itemdata.priceVariation[0].price.toString(),quantity:( qty+1).toString(),var_id: varid);
        ...
        case CartStatus.remove:
          ...
          },price: widget._itemdata.priceVariation[0].price.toString(),quantity:"0",var_id: varid);
          // TODO: Handle this case.
          break;
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Flexible(
                                child: Text(widget._itemdata.itemName,
                                    overflow: TextOverflow.ellipsis,
                                    maxLines: 2,
                                    style: TextStyle(
                                      color: Theme
    ...
    */
    Widget showoptions1() {
      ...
      showDialog(
            ...
            return StatefulBuilder(builder: (context, setState) {
              return  Dialog(
                ...
                child: Container(
                  ...
                  //height: 200,
                  padding: EdgeInsets.fromLTRB(30, 20, 20, 20),
                  child: ItemVariation(widget._itemdata,ismember: (VxState.store as GroceStore).userData.membership =="1",selectedindex: itemindex,onselect: (i){
                    setState(() {
                      itemindex = i;
                      // Navigator.of(context).pop();
                    });
          ...
          context: context,
          builder: (context) {
            return ItemVariation(widget._itemdata,ismember: (VxState.store as GroceStore).userData.membership =="1",selectedindex: itemindex,onselect: (i){
              setState(() {
                itemindex = i;
                // Navigator.of(context).pop();
              });
    ...
    if(_isWeb && !ResponsiveLayout.isSmallScreen(context)) {
      ...
      if ((VxState.store as GroceStore).userData.membership=="1") {
        setState(() {
          _checkmembership = true;
          debugPrint("membership.....4"+_checkmembership.toString());
        });
      } else {
        setState(() {
          _checkmembership = false;
          debugPrint("membership.....5"+_checkmembership.toString());
        });
        for (int i = 0; i < productBox.length; i++) {
          if (productBox[i].mode == "1") {
            setState(() {
              _checkmembership = true;
              debugPrint("membership.....6"+_checkmembership.toString());
            });
          }
        }
      }
        ...
        child: Column(
          children: [
            ItemBadge(
              ...
              /* widgetBadge: WidgetBadge(isdisplay: true,child: widget._itemdata.eligibleForExpress=="1"?Image.asset(Images.express,
                        height: 20.0,
              ...
              child: Align(
                ...
                child: MouseRegion(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      debugPrint("ss.."+widget._seeallpress.toString());
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget._itemdata.priceVariation[itemindex].images.length<=0?widget._itemdata.itemFeaturedImage:widget._itemdata.priceVariation[itemindex].images[itemindex].image,
...
//                            if(varmemberprice.toString() == varmrp.toString())
                                                new TextSpan(
                                                    text: IConstants.currencyFormat + '${_checkmembership?widget._itemdata.priceVariation[itemindex].membershipPrice:widget._itemdata.priceVariation[itemindex].price} ',
                                                    style: new TextStyle(
                                                      fontWeight: FontWeight.bold,
                                                      color: Colors.black,
                                                      fontSize: ResponsiveLayout.isSmallScreen(context) ? 14 : ResponsiveLayout.isMediumScreen(context) ? 14 : 15,)),
                                                new TextSpan(
                                                    text: widget._itemdata.priceVariation[itemindex].membershipPrice!=widget._itemdata.priceVariation[itemindex].mrp?
...
//                            if(varmemberprice.toString() == varmrp.toString())
                                                new TextSpan(
                                                    text: IConstants.currencyFormat +
                                                        *//*'$varmemberprice '*//*widget._itemdata.priceVariation[itemindex].membershipPrice.toString(),
                                                    style: new TextStyle(
                                                      fontWeight:
                                                      FontWeight
                                                          .bold,
                                                ...
                                                new TextSpan(
                                                    text:
                                                    IConstants.currencyFormat +
                                                        *//*'$varmrp '*//*widget._itemdata.priceVariation[itemindex].mrp.toString(),
                                                    style: TextStyle(
                                                      decoration:
                                                      TextDecoration
                                                          .lineThrough,
                                      ...
                                      if(widget._itemdata.eligibleForExpress == "0")
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: ( widget._itemdata.priceVariation.length > 1)
                                ? GestureDetector(
                              onTap: () {
                                setState(() {
                                  //isweb
                          ...
                          if(Features.isSubscription)
                            ...
                            (widget._itemdata.priceVariation[itemindex].stock>=0)?
                            Container(
                                  ...
                                  if(checkskip &&_isWeb && !ResponsiveLayout.isSmallScreen(context)){
                                    ...
                                    Navigator.of(context).pushNamed(
                                        ...
                                        arguments: {
                                          ...
                                          "varprice":  (VxState.store as GroceStore).userData.membership=="1" ? widget._itemdata.priceVariation[itemindex].membershipPrice.toString() :widget._itemdata.priceVariation[itemindex].discointDisplay ?widget._itemdata.priceVariation[itemindex].price.toString():widget._itemdata.priceVariation[itemindex].mrp.toString(),
...
//                                     if(element.varId == widget._itemdata.priceVariation[itemindex].id) {
//                                       {
...
//                                   });
//                                 }
//                                 widget._itemdata.priceVariation[itemindex].quantity = itemCount;
//                               if (itemCount <= 0)
//                                   return GestureDetector(
//                                     onTap: () {
//                                       setState(() {
...
//                                       //addToCart(int.parse(itemvarData[0].varminitem));
//                                      // addToCart(int.parse(varminitem));
//                                       addToCart(widget._itemdata.priceVariation[itemindex],widget._itemdata);
//                                     },
//                                     child: Container(
//                                       height: 30.0,
//                                       width: (MediaQuery.of(context).size.width / 4) + 15,
...
//                                              // _isAddToCart = true;
//                                              // incrementToCart(varQty - 1);
//                                               updateCart(widget._itemdata.priceVariation[itemindex].quantity, CartStatus.decrement, widget._itemdata.priceVariation[itemindex].id);
//                                             });
//                                           },
//                                           child: Container(
//                                               width: 30,
...
//                                                   textColor: Colors.white);
//                                             }*/
//                                             if (widget._itemdata.priceVariation[itemindex].quantity < widget._itemdata.priceVariation[itemindex].stock) {
//                                               if (widget._itemdata.priceVariation[itemindex].quantity < int.parse(widget._itemdata.priceVariation[itemindex].maxItem)) {
//                                                 updateCart(widget._itemdata.priceVariation[itemindex].quantity, CartStatus.increment, widget._itemdata.priceVariation[itemindex].id);
//                                               } else {
//                                                 Fluttertoast.showToast(
//                                                     msg:
//                                                     S.of(context).cant_add_more_item,//"Sorry, you can\'t add more of this item!",
...
//                           ),
                           ...
                           // mainAxisAlignment: MainAxisAlignment.end,
                            children: [
                              SizedBox(
                                  ...
                                  child: CustomeStepper(priceVariation: widget._itemdata.priceVariation[itemindex],itemdata: widget._itemdata,from: "selling_item",)),
                            ],
                          ),
                        ],
                      ),
     ...
     /* for(int i= 0; i<itemvarData.length;i++){
      ...
      return GestureDetector(
        onTap: (){
          if(widget._fromScreen == "sellingitem_screen") {
            if (widget._itemdata.priceVariation[itemindex].stock >= 0)
              navigatetoSingelproductscreen(context,widget.returnparm,
                  duration: widget._itemdata.duration,
                  delivery: widget._itemdata.delivery,
                  note: widget._itemdata.deliveryDuration.note,
          ...
          else if(widget._fromScreen == "wishlist_screen") {
            if (widget._itemdata.priceVariation[itemindex].stock >= 0)
              navigatetoSingelproductscreen(context,widget.returnparm,
                duration: widget._itemdata.duration,
                delivery: widget._itemdata.delivery,
        ...
        child: Card(
         ...
         // margin: EdgeInsets.only(bottom: 12),
          child: Container(
           ...
           // margin: EdgeInsets.only(left: 1.0, top: 5.0, bottom: 1, right: 3),
            child: Column(
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  children: [
                    ItemBadge(
                     ...
                     /* widgetBadge: WidgetBadge(isdisplay: true,child: widget._itemdata.eligibleForExpress=="1"?Image.asset(Images.express,
                      ...
                      child: MouseRegion(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            debugPrint("widget._fromScreen ...."+widget._fromScreen );
                            if(widget._fromScreen == "sellingitem_screen") {
                                navigatetoSingelproductscreen(context,widget.returnparm,
                                    duration: widget._itemdata.duration,
                                    delivery: widget._itemdata.delivery,
                         ...
                         /*   debugPrint("single product...."+{
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              ...
                              errorWidget: (context, url, error) => Image.asset(
                                Images.defaultProductImg,
                                width: ResponsiveLayout.isSmallScreen(context) ? MediaQuery.of(context).size.width : ResponsiveLayout.isMediumScreen(context) ? MediaQuery.of(context).size.width : MediaQuery.of(context).size.width,
                                height: ResponsiveLayout.isSmallScreen(context) ? MediaQuery.of(context).size.height / 3.8 : ResponsiveLayout.isMediumScreen(context) ? 200 : 200,
                              ),
                              placeholder: (context, url) => Image.asset(
                                Images.defaultProductImg,
                                width: ResponsiveLayout.isSmallScreen(context) ? MediaQuery.of(context).size.width  : ResponsiveLayout.isMediumScreen(context) ? MediaQuery.of(context).size.width : MediaQuery.of(context).size.width,
                   ...
                   /* !_isStock
                      ...
                      child: GestureDetector(
                        ...
                        child: CachedNetworkImage(
                          imageUrl:*/
                    /*(widget._fromScreen == "searchitem_screen")?widget.imageUrl:*//*widget._itemdata.priceVariation[itemindex].images.length<=0?widget._itemdata.itemFeaturedImage:widget._itemdata.priceVariation[itemindex].images[itemindex].image,
                          placeholder: (context, url) =>
                              Image.asset(
                                Images.defaultProductImg,
                                width: ResponsiveLayout.isSmallScreen(context) ? 106 : ResponsiveLayout.isMediumScreen(context) ? 90 : 100,
                ...
                Container(
                  ...
                  padding: EdgeInsets.only(bottom:2.0, left: 8.0, right: 6.9, top: 5),
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              setState(() {
                                debugPrint("_fromScreen...."+widget._fromScreen);
                                if(widget._fromScreen == "wishlist_screen"){
                                  if (!widget._itemdata.isSelect) {
                                    debugPrint("AddWishList.....");
                                    Provider.of<MyorderList>(
                                        context, listen: false).AddWishList(
                                        widget._itemdata.id).then((value) {
                                      setState(() {
                                        debugPrint("AddWishList.....true");
                                        widget._itemdata.isSelect = true;
                                        Navigator.of(context).pushReplacementNamed(
                              ...
                              debugPrint("aesrdtfyu....."+widget._itemdata.isSelect.toString());
                            },
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                ...
                                (widget._itemdata.isSelect)? Image.asset(
                                  Images.wishlist,
                                  width: 18,
                                  height: 18,
                                ):
                                  ...
                                  Container(
                                    child: Row(
                                      children: <Widget>[
                                        Expanded(
                                          child: Text(
                                            widget._itemdata.priceVariation[itemindex].fit,
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 1,
                                            style: TextStyle(
                                                fontSize: 11,
                      ...
                      //       //           .width / 3.8) +
                      //       //           25,
                      //       //     child: CustomeStepper(priceVariation: widget._itemdata.priceVariation[itemindex],itemdata: widget._itemdata,)),
                      //       //   ],
                      //       // ),
                      //     ],
                      //   ),
...
Future<bool> navigatetoSingelproductscreen(context,returnparm,{fromScreen,seeallpress,id,title,imageUrl,eligibleforexpress,delivery,duration,durationType,variationdisplaydata,itemvarData,note}) async{
  switch(fromScreen){
