...
class ItemBadge extends StatelessWidget {
  ...
  WidgetBadge widgetBadge;
   ItemBadge({Key key,this.child,this.outOfStock,this.badgeDiscount,this.widgetBadge}) : super(key: key);
    ...
    return Align(
      ...
      child: Container(
        ...
        child: Center(
          ...
          child:   Image.asset(Images.outofStock,height:40,width: 310,),
        ),
      ),
    );
  }
...
class WidgetBadge extends StatelessWidget {
  bool isdisplay;
  Widget child;
   WidgetBadge({Key key,this.isdisplay = false,this.child}) : super(key: key);
